...
class BookingRepositoryImpl(private val dataSource: BookingDataSource): BookingRepository {
    ...
    override fun getAllCars(): Flow<Response<ApiResponse<MutableList<BookingDetails>>>> = flow {
        try {
            val apiResponse = dataSource.getAllCars()
    ...
    override fun getCarsByDate(date: String): Flow<Response<ApiResponse<MutableList<BookingDetails>>>> = flow {
        try {
            val apiResponse = dataSource.getCarsByDate(date)
            emit(Response.Success(apiResponse))
        } catch (e:Exception){
            emit(Response.Error(e))
        }
    ...
    override fun saveBooking(booking: Booking): Flow<Response<ApiResponse<MutableList<BookingDetails>>>> = flow {
        try {
    ...
    override fun updateBooking(booking: Booking): Flow<Response<ApiResponse<MutableList<BookingDetails>>>> = flow {
        try {
    ...
    override fun deleteBooking(id: String): Flow<Response<ApiResponse<MutableList<BookingDetails>>>> = flow {
        try {
